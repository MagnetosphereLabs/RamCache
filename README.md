...
* [File classification and priority tiers](#file-classification-and-priority-tiers)
* [Memory targeting](#memory-targeting)
* [Growth, shrink, and hysteresis](#growth-shrink-and-hysteresis)
* [vmtouch locking model](#vmtouch-locking-model)
* [Chunking model](#chunking-model)
* [Filesystem behavior](#filesystem-behavior)
* [Inotify watcher behavior](#inotify-watcher-behavior)
* [System limits](#system-limits)
* [Sysctl changes](#sysctl-changes)
* [Performance expectations](#performance-expectations)
* [Systems with lots of RAM](#systems-with-lots-of-ram)
* [Systems with less RAM](#systems-with-less-ram)
* [Safety model](#safety-model)
* [Limitations and tradeoffs](#limitations-and-tradeoffs)
* [Troubleshooting](#troubleshooting)
* [Example tuning profiles](#example-tuning-profiles)
